package com.mycompany.deciderzipper;
 ...
 */
public class ZipperV2Decider extends OicrDecider {
	...
	if (ArrayUtils.contains(args,"--verbose")){
        ...
        params.add("--plugin");
        params.add(ZipperV2Decider.class.getCanonicalName());
        params.add("--");
